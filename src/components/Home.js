  ...
  return (
    <div id='home' className='h-screen px-20 content-center text-lg relative'>
      ...
      <div className='content-center'>
        ...
        <Link className='fixed z-50 lg:right-12 lg:bottom-12 right-8 bottom-10 cursor-pointer animate-bounce' to="home" spy={true} smooth={true} offset={-40} duration={500}>
