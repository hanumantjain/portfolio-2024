...
const Contact = () => {
  ...
  return (
    <div id='contact' className='mt-80 px-20 text-xl pb-80'>
        ...
        <div className='flex justify-between pt-20'>
            <div className='flex flex-col gap-3'>
                ...
                <div className='flex gap-2 justify-center items-center'><IoIosMail /><span className=' text-yellow-500'>hanumantjain939@gmail.com</span></div>
