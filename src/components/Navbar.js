  ...
  return (
    <div className='flex flex-col gap-10 text-center 2xl:text-2xl'>
        ...
        <div className='flex flex-col gap-4 px-5 '>
            <Link className='cursor-pointer rounded-2xl p-1 text-xl bg-[#1a1a1a] hover:bg-red-700 2xl:text-2xl' to="home" spy={true} smooth={true} offset={-40} duration={500}>Home</Link>
