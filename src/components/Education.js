  ...
  return (
    <div id='hanumant jain education' className='mt-40'>
        <div className='flex flex-col gap-4'>
            <div className='text-center text-5xl' data-aos="zoom-in">My <span className='text-red-700'>Education</span></div>
            <hr className='mx-10 lg:mx-20'/>
        </div>
        <div className='flex pt-20 flex-col gap-20 lg:flex-row lg:justify-around mx-20'>
            <div className='pl-10 border-l-2 border-white relative text-xl' data-aos='fade-right'>
            ...
            <div className='pl-10 border-l-2 border-white relative text-xl' data-aos='fade-left'>
                <FaGraduationCap className='absolute -top-6 -left-5 rounded-full p-2 text-4xl text-center text-white bg-red-700'/>
